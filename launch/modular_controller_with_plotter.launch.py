#!/usr/bin/env python3
"""
Launch file for modular controller with live plotter for external Gazebo simulator.
"""
...
def generate_launch_description():
    ...
    # Plotter parameters
    enable_plotter_arg = DeclareLaunchArgument('enable_plotter', default_value='true')
    ...
    plotter_node = Node(
        ...
        output='screen',
        parameters=[{
            'asv_odom_topic': LaunchConfiguration('asv_odom_topic'),
            'towfish_odom_topic': LaunchConfiguration('towfish_odom_topic'),
            'waypoints_topic': '/waypoints',
            'history_length': 5000,
            'update_rate_hz': 20,
            'show_tether': True,
            'show_boat_shape': True,
        }],
